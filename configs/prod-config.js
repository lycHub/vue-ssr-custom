{
  ...
  resolve: {
    alias: {
      ...
      _c: 'E:\\vue\\baseui\\src\\components.md'
    },
    extensions: [
      '.mjs',
      '.js',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            ...
            options: {
              cacheDirectory: 'E:\\vue\\baseui\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '604d845c'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '636fa794',
              emitWarning: true,
              emitError: false,
              eslintPath: 'E:\\vue\\baseui\\node_modules\\eslint',
              formatter: undefined
            }
          }
        ]
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'E:\\vue\\baseui\\public\\index.html'
      }
    ),
    /* config.plugin('pwa') */
    new HtmlPwaPlugin(
    ...
    new CopyPlugin(
      [
        {
          from: 'E:\\vue\\baseui\\public',
          to: 'E:\\vue\\baseui\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
